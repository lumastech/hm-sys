    ...
    <Dashboard>
        ...
        <div class="pb-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid md:grid-cols-2 xl:grid-cols-4 gap-4 mb-7">
                    <div class="flex border rounded-md p-2 hover:shadow transition">
                        <svg class="text-primary-300 w-16 h-16 fill-current mr-4" viewBox="0 0 20 20">
                            <path
