            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div
                    ...
                    <div class="relative">
                        ...
                        <input v-model="filters.search" type="text" id="table-search-products"
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-3">
                                    <div v-if="product.image" class="flex-shrink-0 h-10 w-10">
                                        <img class="h-10 w-10 rounded object-cover" :src="`/storage/${product.image}`"
                                            :alt="product.name">
                                    </div>
...
const confirmDelete = () => {
    router.delete(route('products.destroy', deleteDialog.value.id), {
        preserveScroll: true,
        onSuccess: () => {
...
watch(filters, (value) => {
    router.get('/products', { search: value.search }, { preserveState: true });
}, { deep: true });
</script>