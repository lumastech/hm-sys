<template>
    <DashLayout>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div
                    ...
                    <div class="relative">
                        ...
                        <input v-model="filters.search" type="text" id="table-search-projects"
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Collaborators</th>
                        ...
                        <tr v-for="project in projects.data" :key="project.id"
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-3">
                                    <div v-if="project.image" class="flex-shrink-0 h-10 w-10">
                                        <img class="h-10 w-10 rounded object-cover" :src="`/storage/${project.image}`"
                                            :alt="project.name">
                                    </div>
                            ...
                            <td class="px-6 py-4">
                                {{ project.collaborations_count || 0 }}
                            </td>
                            <td class="px-6 py-4">
                                <span :class="{
        ...
        <Create :show="createModal" @close="closeModal" :businesses="businesses" />
    </DashLayout>
</template>
...
const confirmDelete = () => {
    router.delete(route('projects.destroy', deleteDialog.value.id), {
        preserveScroll: true,
        onSuccess: () => {
...
watch(filters, (value) => {
    router.get('/projects', { search: value.search }, { preserveState: true });
}, { deep: true });
</script>