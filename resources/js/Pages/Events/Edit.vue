                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div v-if="event.image" class="mt-2">
                            ...
                            <img :src="`/storage/${event.image}`" class="h-20 mt-1 rounded">
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end space-x-4">
                        <button type="button" @click="$inertia.visit(route('events.show', event.id))"
...
const form = useForm({
    ...
    access: props.event.access,
    description: props.event.description,
    image: null,
    start_date: props.event.start_date ? props.event.start_date.replace(' ', 'T') : '',
    end_date: props.event.end_date ? props.event.end_date.replace(' ', 'T') : '',
    price: props.event.price,
    status: props.event.status,
    business_id: props.event.business_id,
});
