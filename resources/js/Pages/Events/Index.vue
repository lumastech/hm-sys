        ...
        <nav class="text-sm font-semibold mb-6" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li class="flex items-center">
                    <a href="#" class="text-gray-600">Events</a>
                </li>
            </ol>
        </nav>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div
                    ...
                    <div class="relative">
                        ...
                        <input v-model="filters.search" type="text" id="table-search-events"
                        ...
                        <tr v-for="event in events.data" :key="event.id"
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm">
                                    ...
                                    <div v-if="event.end_date" class="text-xs text-gray-500">
                            ...
                            <td class="px-6 py-4">{{ event.access }}</td>
                            <td class="px-6 py-4">
                                <span :class="{
...
const confirmDelete = () => {
    router.delete(route('events.destroy', deleteDialog.value.id), {
        preserveScroll: true,
        onSuccess: () => {
...
watch(filters, (value) => {
    router.get('/events', { search: value.search }, { preserveState: true });
}, { deep: true });
</script>