            ...
            <div class="w-full px-6 flex items-center justify-between">
              ...
              <div class="flex">
                ...
                <div class="relative text-gray-600">
                  <input type="search" name="serch" placeholder="Search products..." class="bg-primary-50 h-10 w-full xl:w-64 px-5 rounded-lg border-primary-400 text-sm focus:outline-none">
              ...
              <div class="flex items-center relative">
                ...
                <img src="https://a7sas.net/wp-content/uploads/2019/07/4060.jpeg" class="w-9 h-9 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
              </div>
